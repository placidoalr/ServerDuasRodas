...
var AddTipoAction = /** @class */ (function (_super) {
    __extends(AddTipoAction, _super);
    function AddTipoAction() {
    ...
    AddTipoAction.prototype.Post = function () {
        ...
        new mysql_factory_1.MySQLFactory().getConnection().select(this.generateSQL()).subscribe(function (data) {
            if (data.length || data.length > 0) {
                console.log(data);
                _this.sendError(new kernel_utils_1.KernelUtils().createErrorApiObject(401, '1001', 'Tipo já existe'));
                return;
            }
            else {
                console.log(data);
    ...
    AddTipoAction.prototype.defineVisibility = function () {
        this.actionEscope = route_types_1.ActionType.atPublic;
    };
    __decorate([
        decorators_1.Post('/AddTipo'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
    ], AddTipoAction.prototype, "Post", null);
    return AddTipoAction;
}(action_1.Action));
exports.AddTipoAction = AddTipoAction;
