...
var OMAction = /** @class */ (function (_super) {
    ...
    OMAction.prototype.insertEQUIPSQL = function (equip) {
        ...
        new mysql_factory_1.MySQLFactory().getConnection().select(this.generateSQL()).subscribe(function (data) {
            if (data.length || data.length > 0) {
                ...
                new mysql_factory_1.MySQLFactory().getConnection().select(_this.insertSQL()).subscribe(function (data) {
                    _this.req.body.equips.array.forEach(function (equip) {
                        new mysql_factory_1.MySQLFactory().getConnection().select(_this.insertEQUIPSQL(equip)).subscribe(function (data) {
                        });
                    });
                });
            }
